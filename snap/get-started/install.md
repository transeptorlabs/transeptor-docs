---
sidebar_position: 1
description: Learn how to install ERC-4337 Relayer Snap.

title: Install
---
import { PopupButton } from '@typeform/embed-react'

This page explains how to install ERC-4337 Relayer Snap.

## Software Prerequisites
To install ERC-4337 Snap, you must install the [MetaMask Flask browser extension](https://metamask.io/flask/).
